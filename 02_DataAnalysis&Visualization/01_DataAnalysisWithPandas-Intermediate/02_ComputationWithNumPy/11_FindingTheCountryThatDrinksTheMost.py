...
# instantiate highest_value & highest_key
highest_value = 0
highest_key = ''
...
for country in countries:
	...
	# Compare current sum to the highest values
	if highest_value < sum_country_consumption:
		highest_value = sum_country_consumption
		highest_key = country

# display country that consumed the most booze and the value
print('\n%s consumed the most alcohol in %s\n%f liters of alcohol was consumed that year.' % (highest_key, year, highest_value))