...
# title_text = 'r value = %f' % correlations['total_enrollment']
# combined.plot.scatter(x='total_enrollment', y='sat_score', title=title_text)


# Create a scatterplot of ell_percent versus sat_score.
# title_text = 'English language learners\nr value = %f' % correlations['ell_percent']
# combined.plot.scatter(x='ell_percent', y='sat_score', title=title_text)
