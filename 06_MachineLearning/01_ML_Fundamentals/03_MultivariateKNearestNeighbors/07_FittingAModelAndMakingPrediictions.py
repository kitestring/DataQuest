...
neigh = KNeighborsRegressor(n_neighbors=5, algorithm='brute')
neigh.fit(train_features, train_target)
# predictions = neigh.predict(test_df[['accommodates', 'bathrooms']])
test_df['price_predictions'] = neigh.predict(test_df[['accommodates', 'bathrooms']])
print(test_df[['price', 'price_predictions']])
